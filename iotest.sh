...
dd if=/dev/zero of=/dev/vdb bs=1G count=6 oflag=dsync
...
dd if=/dev/zero of=/dev/vdb bs=512 count=100000 oflag=dsync
...
dd if=/dev/zero of=/dev/vdb bs=1G count=10 oflag=dsync
