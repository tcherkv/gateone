...
def main():
    ...
    https_server = tornado.httpserver.HTTPServer(
        ...
        "certfile": os.path.join(os.getcwd(), "/gateone/GateOne/gateone/tests/hello_embedded/certificate.pem"),
        "keyfile": os.path.join(os.getcwd(), "/gateone/GateOne/gateone/tests/hello_embedded/keyfile.pem"),
    })
